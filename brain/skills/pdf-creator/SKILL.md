...
```bash
uv run --with weasyprint skills/pdf-creator/scripts/md_to_pdf.py input.md output.pdf
```

Batch convert multiple files:

```bash
uv run --with weasyprint skills/pdf-creator/scripts/batch_convert.py *.md --output-dir ./pdfs
```
